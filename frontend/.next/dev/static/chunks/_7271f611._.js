...
function HomePage() {
    ...
    const [filteredAdSpaces, setFilteredAdSpaces] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const selectedCity = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useLocationStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLocationStore"])({
        "HomePage.useLocationStore[selectedCity]": (state)=>state.selectedCity
    }["HomePage.useLocationStore[selectedCity]"]);
            ...
            if (adSpaces.length > 0) {
                ...
                if (startDate && endDate) {
                    ...
                    filtered = filtered.filter({
                        "HomePage.useEffect": (space)=>space.availability_status === 'available'
                    }["HomePage.useEffect"]);
                }
                ...
                if (appliedFilters) {
                    // Price range filter
                    filtered = filtered.filter({
                        "HomePage.useEffect": (space)=>space.price_per_day >= appliedFilters.priceRange.min && space.price_per_day <= appliedFilters.priceRange.max
                    }["HomePage.useEffect"]);
                    // Footfall range filter
                    filtered = filtered.filter({
                        "HomePage.useEffect": (space)=>space.daily_impressions >= appliedFilters.footfallRange.min && space.daily_impressions <= appliedFilters.footfallRange.max
                    }["HomePage.useEffect"]);
                    // Location filter (if different from selected city)
                    if (appliedFilters.location && appliedFilters.location !== selectedCity) {
                        filtered = filtered.filter({
                            "HomePage.useEffect": (space)=>space.location?.city === appliedFilters.location
                        }["HomePage.useEffect"]);
                    }
                    // Display type filter
                    if (appliedFilters.displayType) {
                        filtered = filtered.filter({
                            "HomePage.useEffect": (space)=>space.display_type === appliedFilters.displayType
                        }["HomePage.useEffect"]);
                    }
                    // Publishers filter
                    if (appliedFilters.publishers && appliedFilters.publishers.length > 0) {
                        filtered = filtered.filter({
                            "HomePage.useEffect": (space)=>appliedFilters.publishers.includes(space.publisher_id)
                        }["HomePage.useEffect"]);
                    }
                    // Sort
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        spaces = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$services$2f$adSpaces$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAdSpaces"])(filters);
                ...
                "HomePage.useEffect.fetchCategories": async ()=>{
                    ...
                    try {
                        ...
                        try {
                            ...
                            // Fallback to direct service call
                            try {
                                cats = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$services$2f$categories$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCategories"])();
                        ...
                        const getCategoryEmoji = {
                            "HomePage.useEffect.fetchCategories.getCategoryEmoji": (name)=>{
                        ...
                        }["HomePage.useEffect.fetchCategories.getCategoryEmoji"];
                        setCategories(cats.map({
                            "HomePage.useEffect.fetchCategories": (cat)=>({
                                    id: cat.id,
                                    name: cat.name,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        ...
                        children: [
                            ...
                            categoriesLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                className: "grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-4",
                                children: displayCategories.map((category)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: [
                                            selectedCategory === category.id && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            category.icon_url ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        children: [
                            ...
                            loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                lineNumber: 562,
                                columnNumber: 13
                            }, this) : filteredAdSpaces.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    !loading && adSpaces.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            !loading && filteredAdSpaces.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(HomePage, "RNBaLToFMweqmOYpeXlatiWO2kw=", false, function() {
    return [
...
//# sourceMappingURL=_7271f611._.js.map