    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HomePage.useEffect": ()=>{
            ...
            if (categories.length > 0 && adSpaces.length > 0) {
                const categoriesWithoutCounts = categories.filter({
                    "HomePage.useEffect.categoriesWithoutCounts": (cat)=>cat.count === undefined || cat.count === null
                }["HomePage.useEffect.categoriesWithoutCounts"]);
                if (categoriesWithoutCounts.length > 0) {
                    setCategories({
                        "HomePage.useEffect": (prevCategories)=>prevCategories.map({
                                "HomePage.useEffect": (cat)=>{
                                    // Only calculate if count is missing
                                    if (cat.count === undefined || cat.count === null) {
                                        const count = adSpaces.filter({
                                            "HomePage.useEffect": (space)=>space.category?.id === cat.id
...
_s(HomePage, "Hxs0u/fbBJaCiUiZd3ijWmaJDG4=", false, function() {
    return [
...
//# sourceMappingURL=_c3279f0e._.js.map